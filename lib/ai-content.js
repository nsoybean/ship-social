...
function resolveImageModel() {
  ...
  if (hasOpenAIKey()) {
    ...
    // Without AI Gateway, always use OpenAI image models.
    // AI_IMAGE_MODEL is gateway-only and is ignored in this path.
    const preferredOpenAIModel = stripOpenAIPrefix(OPENAI_IMAGE_MODEL);
    const modelId =
      preferredOpenAIModel && !preferredOpenAIModel.includes("/")
